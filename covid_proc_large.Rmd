...
## Summary: We have seen the top 10 covid procuring states by number of procurements and amounts. Mahrashtra has spent half as much on 127 procurements as Madhya Pradesh did on 9. However, many of the awards information for procurements have not been inputted correctly. Some of them have mentioned a single line items price but not the price for supplying that item for the year. This could bring in some degree of error
